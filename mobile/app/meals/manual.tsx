...
export default function ManualMealScreen() {
  ...
  return (
    <MealScreen title={existing ? 'Edit meal' : 'Manual entry'} subtitle="Add as much detail as you know" action={<Pressable onPress={save} style={styles.save}><Text style={[type.labelSm, { color: palette.onPrimary }]}>Save</Text></Pressable>}>
      ...
      <View style={styles.twoColumns}><View style={styles.flex}><Field label="Quantity" value={quantity} onChangeText={setQuantity} placeholder="1" keyboardType="decimal-pad" /></View><View style={styles.flex}><Field label="Unit" value={unit} onChangeText={setUnit} placeholder="serving" /></View></View>
